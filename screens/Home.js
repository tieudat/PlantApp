  ...
  const renderNewPlants = ( item,index) => {
    return (
      <View style ={{alignItems: 'center', justifyContent: 'center', marginHorizontal: SIZES.base}}>
          ...
          >
              <Text style = {{color: COLORS.width, ...FONTS.body4}}>{item.name}</Text>
          </View>
          <TouchableOpacity 
              style = {{
                position: 'absolute',
    ...
    <View style={styles.container}>
      ...
      <View style = {{ height:"50%", backgroundColor: COLORS.lightGray}}>
              ...
              >
                  ...
                  <View style= {{ flexDirection: 'row', height:"88%", marginTop: SIZES.base, paddingBottom: SIZES.base}}>
                    <View style ={{ flex:1}}>
                      <TouchableOpacity
                        style ={{ flex:1}}
      ...
      <View style = {{ height:"20%", backgroundColor: COLORS.lightGray}}>
        <View style ={{flex:1, backgroundColor: COLORS.lightGray}}>
          <View style = {{ marginTop: SIZES.radius, marginHorizontal: SIZES.padding}}>
            <Text style ={{color: COLORS.secondary, ...FONTS.h2}}>Add Friend</Text>
